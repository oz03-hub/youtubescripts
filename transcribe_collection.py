...
#     filename
#     for filename in os.listdir(
#         os.path.join(ROOT_DIR, "collections", collection, "transcripts")
#     )
...
#     with open(
#         os.path.join(
#             ROOT_DIR, "collections", collection, "metadata", f"{video_id}.json"
#         ),
#         "r",
#     ) as f:
...
#     selected_metadata["upload_date"] = datetime.strptime(
#         video_metadata["upload_date"], "%Y%m%d"
#     ).strftime("%x")
#     selected_metadata["view_count"] = video_metadata["view_count"]
#     with open(
#         os.path.join(
#             ROOT_DIR, "collections", collection, "transcripts", transcript_file
#         ),
#         "r",
#     ) as f:
...
# with open(
#     os.path.join(ROOT_DIR, "collections", collection, "transcripts.csv"), "w"
# ) as f:
